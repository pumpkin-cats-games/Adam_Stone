...
monogatari.script({
  Start: [
    ...
    "g На жаль, це не сон, Адаме. І скоро тут буде армія Зевса, а ви ще не готові до цієї зустрічі. Тому нам слід…",
  ...
  Act6_death_weapon: [
    ...
    "a <i> Зараз! </i>",
    "show scene act6_backgroundDeathfile with fadeIn",
